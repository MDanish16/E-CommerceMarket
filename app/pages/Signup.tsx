...
export default function Signup() {
  ...
  return (
    <div className="pt-24 min-h-screen bg-gradient-to-br from-pink-50 to-blue-100 animate-fade-in flex items-center justify-center">
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md animate-fade-in-up">
        <h1 className="text-3xl font-extrabold text-blue-700 mb-6 text-center font-sans animate-slide-in">Sign Up</h1>
